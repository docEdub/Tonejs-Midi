...
var Header = /** @class */ (function () {
                    ...
                    if (event.meta) {
                        if (event.type === "timeSignature") {
                            ...
                            _this.keySignatures.push({
                                key: exports.keySignatureKeys[event.scale][event.key + 7],
    ...
    Header.prototype.update = function () {
        ...
        this.timeSignatures.forEach(function (event, index) {
            ...
            var elapsedMeasures = beatsToMeasures(elapsedBeats, lastEvent.timeSignature);
...
function beatsToMeasures(beats, timeSignature) {
